...
export const COPY = {
  ...
  failed_update: 'No pudimos actualizar los colectivos.',
  retry: 'Reintentar',
  upstream_unavailable: 'No pudimos actualizar los colectivos.',
  no_vehicles: 'No hay ubicaciones recientes de esta línea.',
  ...
  my_location: 'Mostrar mi ubicación',
